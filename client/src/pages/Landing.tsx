...
export default function Landing() {
  return (
    <div className="relative min-h-screen overflow-hidden flex flex-col">
      ...
      {/* Top Nav - only logo */}
      <nav className="relative z-10 flex items-center px-8 py-5 max-w-[1400px] mx-auto w-full">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 -mt-8">
        ...
        <motion.p
          ...
          className="text-white/60 text-lg md:text-xl max-w-xl mb-10 font-heading font-light"
        >
      ...
      {/* Footer */}
      <footer className="relative z-10 pb-8 px-4 mt-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass-card p-5 mb-5">
            <h3 className="text-white/80 text-sm font-heading font-semibold mb-3 text-center">
              Official Contact
            </h3>
            <div className="flex flex-col md:flex-row items-center justify-center gap-5 text-sm">
              <a href="https://x.com/renaissxyz" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 text-white/50 hover:text-white transition-colors no-underline">
          ...
          <div className="text-center">
            <p className="text-white/25 text-xs font-heading leading-relaxed">
            ...
            <p className="text-white/15 text-xs mt-2 font-heading">
              &copy; 2026 TCGPlay Community. Free to play.
            </p>
          </div>
        </div>
      </footer>
